    ...
    await sheets.spreadsheets.values.update({
      ...
      requestBody: {
        values: [
          ...
          ['Time This Week:', '=SUMIF(B10:B,">="&TODAY()-WEEKDAY(TODAY(),2)+1,H10:H)', 'Time This Year:', '=SUMIF(B10:B,">="&DATE(YEAR(TODAY()),1,1),H10:H)', 'Total Activities:', '=COUNTA(B10:B)', '', '', ''],
          ['Total Distance (This Week):', '=SUMIF(B10:B,">="&TODAY()-WEEKDAY(TODAY(),2)+1,G10:G)', 'Total Distance (This Year):', '=SUMIF(B10:B,">="&DATE(YEAR(TODAY()),1,1),G10:G)', '', '', '', '', ''],
          ['Races This Year:', '=SUMPRODUCT((B10:B>=DATE(YEAR(TODAY()),1,1))*(ISNUMBER(SEARCH("race",LOWER(D10:D))))*1)', '', '', '', '', '', '', ''],
          ['', '', '', '', '', '', '', '', ''],
          ['', '', '', '', '', '', '', '', ''],
          ['', '', '', '', '', '', '', '', ''],
